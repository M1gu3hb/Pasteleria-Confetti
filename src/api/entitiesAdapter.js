...
const COLUMNS = {
  ...
  configuracion_negocio: ['nombre_negocio','nombre_sistema','platform_brand','logo_url','logo_ticket_url','logo_pdf_url','background_logo_url','background_image_url','background_fit','background_opacity','color_primario','color_secundario','color_acento','colorear_importes_monetarios','moneda','simbolo_moneda','iva_porcentaje','paquete_modo','usa_mesas','usa_cocina','usa_barra','permitir_venta_sin_stock','mostrar_costos_a_caja','mostrar_logo_ticket','mensaje_ticket','ticket_footer','pdf_footer','footer_text','descargar_pdf_corte_auto','formato_export_default','modo_presentacion_activo','presentacion_password','hora_inicio_dia_operativo','precio_kilo_global','precio_kilo_es_global','precio_kilo_por_sucursal','ratio_personas_por_kilo','ratio_personas_es_global','ratio_personas_por_sucursal','extras_pastel','rellenos_pastel','direccion','telefono','whatsapp','correo'],
