...
- **usuarios_login**: id, nombre, rol, sucursal_id, sucursal_nombre, color, activo (sin pin_hash) — para el selector de login. (anon SELECT) — ⚠️ al crear cuentas terminal, filtrar `pin_hash is not null` para excluirlas.
...
0001 esquema_unificado · 0002 hardening_anon_grants · 0003 harden_siguiente_folio_execute · 0004 harden_rls_auto_enable_execute · 0005 ajustes_schema_datos_vivos · 0006 seed_datos_maestros · 0007 config_campos_json_string (jsonb→text) · 0008 storage_bucket_uploads · 0009 actor_ids_a_text · 0010 config_propinas_activas · 0011 config_sonidos_activos · 0012 fase4_rls_por_rol_sucursal · 0013 fase4_drop_pin_plano · 0014 fase4_login_pos_rpc.
